...
## INITIAL SET UP
-  `npx create-react-app client` sahand use `npm create vite@latest client`
-  index.js in create react app is main.jsx in create vite
-  App.js in create react app is App.jsx in create vite
-  `npm i` install everything from react and react dom
- INSTALL TAILWIND CSS (go to tailwind site)
   -  `npm install -D tailwindcss postcss autoprefixer`
   `npx tailwindcss init` create tailwind.config.js file and this file needs to modify
   - create `postcss.config.js`
   - modify index.css as per tailwind docs.

### clean up folder
- empty `App.js` and `rfc`
